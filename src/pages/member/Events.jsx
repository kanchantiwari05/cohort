  ...
  return (
    <div className="p-3 space-y-6">
      <div>
        ...
        <p className="text-secondary text-sm mt-1">Events and registrations</p>
      </div>
      <div className="card flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-secondary text-sm mt-2 max-w-xs">Events and registrations. This module will be fully built in the next phase.</p>
      </div>
    </div>
  )
}
